...
class CountDown extends React.Component {
  ...
  constructor(props) {
    super(props);
    this.timer = setInterval(this.updateTimer, 1000 * this.props.timeIntervar);
  }
  ...
  updateTimer = () => {
    ...
    if (this.state.until === 0) {
      ...
      this.setState({
        lastUntil: this.state.until,
        until: Math.max(0, this.state.until - 1 * this.props.timeIntervar),
      });
    }
  };
