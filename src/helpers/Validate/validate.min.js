  ...
  (e.extend = function (a) {
    ...
    e.extend(d, {
      ...
      processValidationResults: function (a, b) {
        ...
        if (typeof e.formatters[c] !== 'function') {
      ...
      result: function (a) {
        ...
        return typeof a === 'function' && (a = a.apply(null, b)), a;
      },
      isNumber: function (a) {
      ...
      isEmpty: function (a) {
        ...
        if (e.isString(a)) {
          return e.EMPTY_STRING_REGEXP.test(a);
        }
        if (e.isArray(a)) {
          return a.length === 0;
        }
      ...
      collectFormValues: function (a, b) {
        var c,
          ...
          i,
          j = {};
        if ((e.isJqueryElement(a) && (a = a[0]), !a)) {
          return j;
        }
        for (
          b = b || {},
            ...
            (i = e.sanitizeFormValue(f.value, b)),
              f.type === 'number'
                ...
                ? f.attributes.value
                  ...
                  : (i = f.checked)
                : f.type === 'radio' && (f.checked || (i = j[k] || null)),
              (j[k] = i);
          }
        }
        for (g = a.querySelectorAll('select[name]'), c = 0; c < g.length; ++c) {
          if (((f = g.item(c)), !e.isDefined(f.getAttribute('data-ignored')))) {
            if (f.multiple) {
              ...
              var l =
                typeof f.options[f.selectedIndex] !== 'undefined'
